chrome.webRequest.onBeforeSendHeaders.addListener(
  (details) => {
    ...
    for (const header of details.requestHeaders) {
      if (header.name != "User-Agent") continue;

      // New user agent does the magic
      header.value =
        "Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4400.8 Mobile Safari/537.36";
      console.log("[GOOGLE GIFS AUTOPLAY]: HEADERS CHANGED!");
    }
    return {
